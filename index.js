window.addEventListener("load", function () 
{
  ...
  var buildUrl = "Build";
  var loaderUrl = buildUrl + "/telegram-app-build-dev.loader.js";
  var config = {
    dataUrl: buildUrl + "/telegram-app-build-dev.data",
    frameworkUrl: buildUrl + "/telegram-app-build-dev.framework.js",
    codeUrl: buildUrl + "/telegram-app-build-dev.wasm",
